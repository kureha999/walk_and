...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jquery-rails>.freeze, [">= 4.0.5".freeze, "< 5.0.0".freeze])
  s.add_runtime_dependency(%q<jquery-ui-rails>.freeze, [">= 5.0.2".freeze])
  s.add_runtime_dependency(%q<momentjs-rails>.freeze, [">= 2.9.0".freeze])
